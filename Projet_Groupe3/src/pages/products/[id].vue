...
// const props = defineProps<{ id: string; photo: string }>();

// const artiste = await allProducts(props.id);
// const img0 = product.photo;
// const urlImg0 = img0 && pb.getFileUrl(artiste, img0, { thumb: '100x200' });

</script>
<template>
    <!-- Version Desktop
    <div class="fixed invisible transition-opacity duration-300 ease-in-out transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
        :class="{ '!visible': activePopUp }" v-scroll-lock="activePopUp">
        <div class="md:w-[600px] hidden md:block border-grey border-2 rounded-2xl">
            ...
            <div class="bg-white rounded-b-xl">
                <div class="flex gap-4 p-10">
                    ...
                    <div class="flex-grow">
                        <h5>{{ designation}}</h5>
                        <p class="my-2">{{ price }} € {{ price_type }}</p>
        ...
        <div class="w-[300px] my-10 md:hidden border-grey border-2 rounded-2xl">
            ...
            <div class="bg-white rounded-b-xl">
                <div class="py-6">
                    ...
                    <p class="my-2 text-center">{{ price }} € {{ price_type }}</p>
