...
<template>
    <div class="relative">
        ...
        <div class="absolute top-0 left-0 flex items-center justify-center w-full h-full">
            <h1 class="top-banner">Nos partenaires</h1>
        </div>
    </div>
    <div class="px-[8vw] py-6">
        <h2 class="mb-4 leading-tight">Nous sommes fiers de travailler en collaboration avec des éco-partenaires</h2>
        <p>Ils nous soutiennent, nous financent et croient en nos valeurs.</p>
        <div class="justify-around gap-8 p-8 lg:flex lg:my-10">
