...
<template>
    <div class="relative">
        ...
        <div class="absolute top-0 left-0 flex items-center justify-center w-full h-full">
            <h1 class="top-banner">Comment fonctionnent les dons ?</h1>
        </div>
    </div>
    <div class="flex w-full">
        <RouterLink to="/"
            class="w-1/2 px-4 py-2 text-center text-white uppercase bg-lightgreen lg:mt-0 active:border-lightgreen hover:drop-shadow-lg active:border-4 lg:text-xl">
            Donner</RouterLink>
        <RouterLink to="/"
    ...
    <section class="px-[8vw] py-12">
        ...
        <div class="items-start gap-8 lg:flex">
            <div>
                ...
                <p>Pour ce faire, il vous suffira de remplir un formulaire que vous pourrez télécharger ici.</p>
